...
def option_menu(foreground, options, background=None, regions=[]):
    ...
    options: a dict of options to include in the menu
             ...
             Each value defines the options
...
class InputHandler():
    ...
    quit: a quit message has been generated by the user
        or operating system. You should exit if this variable is True
    ...
    pressed: a button has been pressed, or a key with repeat enabled
        has been held long enough to trigger another event. Pressed
    ...
    def process(self):
        '''
        Polls the sdl2 event handler for events and updates the quit, update
        and pressed variables.
        '''
